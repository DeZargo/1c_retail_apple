...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ТабачнаяПродукция") Тогда
		ЕстьОтборПоТабачнойПродукции = Истина;
		ТабачнаяПродукция = Параметры.ТабачнаяПродукция;
		ОтборыСписковКлиентСервер.ИзменитьЭлементОтбораСписка(
			ПодборТаблицаНоменклатура,
			"ТабачнаяПродукция",
			ТабачнаяПродукция,
...
Процедура ВариантОтбораПриИзменении()
	...
	Если ЕстьОтборПоТабачнойПродукции Тогда
		ОтборыСписковКлиентСервер.ИзменитьЭлементОтбораСписка(
			ПодборТаблицаНоменклатура,
			"ТабачнаяПродукция",
			ТабачнаяПродукция,

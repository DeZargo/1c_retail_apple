...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппаУпаковок = Элементы.Добавить("ТоварыУпаковкаЕдиницаИзмерения", Тип("ГруппаФормы"), Элементы.Сопоставление.ПодчиненныеЭлементы.СопоставлениеДанныеИБ);
	ГруппаУпаковок.Вид = ВидГруппыФормы.ГруппаКолонок;
	ГруппаУпаковок.Группировка = ГруппировкаКолонок.ВЯчейке;
	
	ЭлементУпаковок = Элементы.Сопоставление.ПодчиненныеЭлементы.СопоставлениеДанныеИБ.ПодчиненныеЭлементы.СопоставлениеУпаковка;
	Элементы.Переместить(ЭлементУпаковок, ГруппаУпаковок);
	
	ДобавленныйРеквизитЕИ = Новый РеквизитФормы("ТоварыНоменклатураЕдиницаИзмерения", Новый ОписаниеТипов("СправочникСсылка.БазовыеЕдиницыИзмерения"), "Объект.Сопоставление");
	МассивДобавленныхРеквизитов = Новый Массив;
	МассивДобавленныхРеквизитов.Добавить(ДобавленныйРеквизитЕИ);
	ИзменитьРеквизиты(МассивДобавленныхРеквизитов);
	
	ЭлементФормыЕИ = Элементы.Добавить("ТоварыНоменклатураЕдиницаИзмерения", Тип("ПолеФормы"), ГруппаУпаковок);
	ЭлементФормыЕИ.Вид = ВидПоляФормы.ПолеНадписи;
	ЭлементФормыЕИ.ПутьКДанным = "Объект.Сопоставление.Номенклатура.ЕдиницаИзмерения";
	
	//Установим видимость поля единица измерения если упаковка не доступна
...
Процедура СопоставлениеУпаковкаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбработкаТабличнойЧастиТоварыКлиент.ВыбратьУпаковкуНоменклатуры(ДанныеВыбора, СтандартнаяОбработка, Элементы.Сопоставление.ТекущиеДанные);
...
Процедура СопоставлениеУпаковкаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Элементы.Сопоставление.ТекущиеДанные.Упаковка = ВыбранноеЗначение;

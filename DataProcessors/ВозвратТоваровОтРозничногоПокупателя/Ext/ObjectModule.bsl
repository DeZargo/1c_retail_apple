...
Процедура СформироватьВозвратТоваровОтПокупателя() Экспорт
	...
	ВозвратТоваровОтПокупателя.СистемаНалогообложения = ПодключаемоеОборудованиеРТ.ПолучитьСистемуНалогообложения(ТекущаяДатаСеанса(),
																ВозвратТоваровОтПокупателя.Организация,
																ВозвратТоваровОтПокупателя.Магазин,

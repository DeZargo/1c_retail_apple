...
Процедура УстановитьВидимостьНастройкиЗадания()
	...
	Если (ОбщегоНазначения.РазделениеВключено() И Пользователи.ЭтоПолноправныйПользователь(, Истина)) Или Не ОбщегоНазначения.РазделениеВключено() Тогда
		Элементы.ПредставлениеРасписания.Видимость = Объект.СпособВыполнения = Перечисления.СпособВыполненияПроверки1.ПоОбщемуРасписанию
			Или Объект.СпособВыполнения = Перечисления.СпособВыполненияПроверки1.ПоОтдельномуРасписанию;
	Иначе
		Элементы.ПредставлениеРасписания.Видимость = Ложь;
	КонецЕсли;
...
Процедура СформироватьСтрокуСРасписанием(ИдентификаторРегламентногоЗадания)
	...
	Если Объект.СпособВыполнения = Перечисления.СпособВыполненияПроверки1.ПоОбщемуРасписанию Тогда
	...
	ИначеЕсли Объект.СпособВыполнения = Перечисления.СпособВыполненияПроверки1.ПоОтдельномуРасписанию Тогда

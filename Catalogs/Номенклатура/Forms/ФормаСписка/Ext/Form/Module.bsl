...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = РаботаСНоменклатуройКлиент.ОписаниеОповещенийПодсистемы().ЗагрузкаНоменклатуры Тогда
		...
		Если Параметр.Свойство("ИдентификаторВладельца", ИдентификаторВладельца) И
			ИдентификаторВладельца = УникальныйИдентификатор И
			Параметр.Свойство("СозданныеОбъекты", СозданныеОбъекты) И
			ТипЗнч(СозданныеОбъекты) = Тип("Массив") И
			СозданныеОбъекты.Количество() > 0 Тогда
		
			ЭтотОбъект.ТекущийЭлемент = Элементы.Список;
			Элементы.Список.ТекущаяСтрока = СозданныеОбъекты[0].Номенклатура;

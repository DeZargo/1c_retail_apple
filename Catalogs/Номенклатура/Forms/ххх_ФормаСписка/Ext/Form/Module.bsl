...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//реквизит1=справочники.Номенклатура.НайтиПоКоду("00-00000004");
	//
	...
	список.Параметры.УстановитьЗначениеПараметра("КрасныйЦенник",КрасныйЦенник);
	список.Параметры.УстановитьЗначениеПараметра("Вход",Справочники.ххх_Справочник.ЗакупочнаяЦена.Значение);
	список.Параметры.УстановитьЗначениеПараметра("Выход",Справочники.ххх_Справочник.РозничнаяЦена.Значение);
	список.Параметры.УстановитьЗначениеПараметра("ФорматМагазина",Справочники.ххх_Справочник.Магазин.Значение.ФорматМагазина);

	СписокГрупп.Параметры.УстановитьЗначениеПараметра("Магазин",Справочники.ххх_Справочник.Магазин.Значение);


	//
	Элементы.СписокГрупп.Отображение=ОтображениеТаблицы.Дерево;
...
&НаКлиенте
Процедура НеПоказыватьЗапрещенныеКЗакупке(Команда)
	Элементы.список.КоманднаяПанель.ПодчиненныеЭлементы.СписокНеПоказыватьЗапрещенныеКЗакупке.Пометка=
		не Элементы.список.КоманднаяПанель.ПодчиненныеЭлементы.СписокНеПоказыватьЗапрещенныеКЗакупке.Пометка;
	НеПоказыватьЗапрещенныеКЗакупкеНаСервере(Элементы.список.КоманднаяПанель.ПодчиненныеЭлементы.СписокНеПоказыватьЗапрещенныеКЗакупке.Пометка);
КонецПроцедуры

&НаСервере
Процедура НеПоказыватьЗапрещенныеКЗакупкеНаСервере(НеПоказыватьЗапрещенныеКЗакупкеНаСервере)
	...
	ОтборыСписковКлиентСервер.ИзменитьЭлементОтбораСписка(
		Список,
		"ВАсортименте",
		НеПоказыватьЗапрещенныеКЗакупкеНаСервере,
		НеПоказыватьЗапрещенныеКЗакупкеНаСервере, ВидСравненияДляОтбора
	);

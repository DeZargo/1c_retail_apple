...
Процедура  ПослеОбработкиШтрихкодов(РезультатОбработкиШтрихкода,КэшированныеЗначения)
	...
	Если РезультатОбработкиШтрихкода.Свойство("ДобавленныеСтроки") Тогда 
		Для Каждого Строка Из РезультатОбработкиШтрихкода.ДобавленныеСтроки Цикл 
			...
			ШтрихкодУпаковки = Справочники.ШтрихкодыУпаковокТоваров.ПолучитьАкцизнуюМаркуПоКоду(Строка.Штрихкод);
			Если Не ИнтеграцияМОТПРТ.ШтрихкодУпаковкиПрисутствует(ШтрихкодУпаковки, Объект) Тогда 
				...
				СтруктураПараметров.ШтрихкодУпаковкиЕГАИС = ШтрихкодУпаковки;
	...
	ИнтеграцияМОТПРТ.ЗаполнитьШтрихкодыВДокумент(МассивШтрихкодовУпаковок, Объект);
	ПроверкаИПодборПродукцииМОТП.ЗаполнитьКешШтрихкодовУпаковок(ЭтотОбъект, ПараметрыИнтеграцииФормыПроверкиИПодбора());
...
Процедура ТоварыНаименованиеНоменклатурыПоставщикаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСКонтрагентамиКлиент.ОткрытьВыборНоменклатурыКонтрагента(Объект.Контрагент, Элемент);
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ОбработкаТабличнойЧастиТоварыСервер.ЗаполнитьМаркируемаяПродукцияГосИС(Объект.Товары);
	ПроверкаИПодборПродукцииМОТПВызовСервера.ПрименитьКешШтрихкодовУпаковок(ЭтотОбъект, ПараметрыИнтеграцииФормыПроверкиИПодбора(), Истина);

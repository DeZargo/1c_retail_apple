...
Функция ДобавитьНайденныеПозицииТоваров(СтруктураПараметров) Экспорт 
	...
	Если Не ДанныеНоменклатуры.ЭтоТабачнаяПродукция Тогда 
...
Процедура  ПослеОбработкиШтрихкодов(РезультатОбработкиШтрихкода,КэшированныеЗначения)
	...
	Если РезультатОбработкиШтрихкода.Свойство("ДобавленныеСтроки") Тогда 
		Для Каждого Строка Из РезультатОбработкиШтрихкода.ДобавленныеСтроки Цикл 
			...
			СтруктураПараметров.ТипУпаковки = РезультатОбработкиШтрихкода.ТипУпаковки;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		ПараметрыОбработки.Вставить("УчитыватьТабак", Ложь);
		ОбработкаТабличнойЧастиТоварыСервер.ЗаполнитьНеобходимостьВводаАкцизнойМарки(Объект.Товары, ПараметрыОбработки);
	КонецЕсли;

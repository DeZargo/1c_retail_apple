...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если СтруктураДанных.ИспользоватьОрдернуюСхемуПриОтгрузке Тогда
	...
	Иначе
		...
		ТекстСообщения = НСтр("ru = 'Для магазина %Магазин% распределение отгрузки товаров по складам не требуется.'");
...
Функция ПодготовитьСтруктуруДанных(ПараметрКоманды)
	...
	СтруктураПараметры.Вставить("Магазин",                             ПараметрКоманды.МагазинОтправитель);
	СтруктураПараметры.Вставить("Склад",                               ПараметрКоманды.СкладОтправитель);
	СтруктураПараметры.Вставить("ИспользоватьОрдернуюСхемуПриОтгрузке",ПараметрКоманды.МагазинОтправитель.ИспользоватьОрдернуюСхемуПриПеремещении);

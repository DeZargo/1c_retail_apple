...
// * Идентификатор - Строка - код идентификации групповой упаковки.
...
Функция СоставКодаМаркировки(КодМаркировки) Экспорт
	...
	СоставКодаМаркировки = Новый Структура("ГрупповаяУпаковка, GTIN, Идентификатор, МРЦ, КодПроверки");
	...
	Если ЭтоКодМаркировкиБлока(КодМаркировки) Тогда
		...
		Если ДанныеШтрихкода21 <> Неопределено Тогда
			СоставКодаМаркировки.Идентификатор = ДанныеШтрихкода21.Значение;
		КонецЕсли;

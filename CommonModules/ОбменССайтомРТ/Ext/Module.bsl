...
Процедура ЗаполнитьЗаказ(ДокументОбъект, РеквизитыЗаказа, СвойстваЗаказа, ПрикладныеПараметры, ОписаниеОшибки, Успешно) Экспорт
	...
	Если ЗначениеЗаполнено(РеквизитыЗаказа.Контрагент) Тогда
		...
		АдресДоставки = УправлениеКонтактнойИнформацией.ПредставлениеКонтактнойИнформацииОбъекта(
			РеквизитыЗаказа.Контрагент,
...
Процедура ИдентифицироватьКонтрагента(СтруктураСвойстваЗаказа, ДанныеКонтрагента, ПрикладныеПараметры, ОписаниеОшибки) Экспорт
	...
	Если ПустаяСтрока(ИНН) И НЕ ПустаяСтрока(Телефон) Тогда
	...
	ИначеЕсли НЕ ПустаяСтрока(ИНН) Тогда
...
Функция НайтиСоздатьЕдиницуИзмерения(ДанныеЕдиницыИзмерения)
	...
	Если ЗначениеЗаполнено(КодБазовойЕдиницы)Тогда
		ЕдиницаИзмерения = ЭлектронноеВзаимодействиеРТ.НайтиСсылкуНаОбъектПоРеквизиту("БазовыеЕдиницыИзмерения", 
			"Код", КодБазовойЕдиницы);
	...
	Если ЗначениеЗаполнено(НаименованиеБазовойЕдиницы) Тогда
		ЕдиницаИзмерения = ЭлектронноеВзаимодействиеРТ.НайтиСсылкуНаОбъектПоРеквизиту("БазовыеЕдиницыИзмерения", 
				"Наименование", НаименованиеБазовойЕдиницы);
		Возврат ЕдиницаИзмерения;
	КонецЕсли;

...
Функция ПолучитьДокументОРП(ОтчетОРП, РеквизитыККМ, Комментарий)
...
Процедура СоздатьИЗаполнитьОтчетОПродажах(МассивСозданныхДокументов, РеквизитыККМ, ТаблицыДанных,
	...
	ПакетДанныхОРП = ПолучитьПакетДанныхОРП(ТаблицыДанных, РеквизитыККМ);
	...
	Для Каждого ОтчетОРП Из ТаблицыДанных.ТаблицаКлючевыхРеквизитовОРП Цикл
		...
		ОтчетОРозничныхПродажахОбъект = ПолучитьДокументОРП(ОтчетОРП, РеквизитыККМ, Комментарий);
		...
		Если ВыборкаПоМаркамГруппировка.НайтиСледующий(ОтчетОРП.УникальныйИдентификаторОтчета,
			...
			Пока ВыборкаПоМаркам.Следующий() Цикл
				...
				Иначе
					...
					ТипШтрихкода = ШтрихкодированиеИС.ОпределитьТипШтрихкода(Марка, Неопределено);
					...
					СтруктураШтрихкодаУпаковки.ТипШтрихкода = ТипШтрихкода;
					Если ТипШтрихкода = Перечисления.ТипыШтрихкодов.GS1_128 Тогда
						СтруктураШтрихкодаУпаковки.ТипУпаковки    = Перечисления.ТипыУпаковок.МонотоварнаяУпаковка;
					ИначеЕсли ТипШтрихкода = Перечисления.ТипыШтрихкодов.DataMatrix Тогда
						СтруктураШтрихкодаУпаковки.ТипУпаковки    = Перечисления.ТипыУпаковок.МаркированныйТовар;
					КонецЕсли;
					СтруктураШтрихкодаУпаковки.Количество     = 1;
					СтруктураШтрихкодаУпаковки.ЗначениеШтрихкода = СтрокаМарка.Марка;
...
Функция ПолучитьПакетДанныхОРП(ТаблицыДанных, РеквизитыККМ)

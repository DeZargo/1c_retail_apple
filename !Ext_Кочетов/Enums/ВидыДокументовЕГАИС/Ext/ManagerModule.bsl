...
//Функция КочетовПрефиксПространстваИмен(ПространствоИмен)
...
//&Вместо("ПространствоИмен")
//Функция КочетовПространствоИмен(ВидДокумента, ФорматОбмена, ТекстОшибки)
...
//		Возврат ?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V3,"http://fsrar.ru/WEGAIS/ActTTNSingle_v3", 
//		?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V2, "http://fsrar.ru/WEGAIS/ActTTNSingle_v2", "http://fsrar.ru/WEGAIS/ActTTNSingle")
//		 );
...
//		
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ххх_АктФиксацииМарок Тогда
//		Возврат "http://fsrar.ru/WEGAIS/ActFixBarCode";
//		
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ххх_АктРазфиксацииМарок Тогда
//		Возврат "http://fsrar.ru/WEGAIS/ActUnFixBarCode";
//		
...
//		Возврат ?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V3, "http://fsrar.ru/WEGAIS/TTNSingle_v3", "http://fsrar.ru/WEGAIS/TTNSingle_v2");
//		
...
//&Вместо("АдресЗапроса")
//Функция КочетовАдресЗапроса(ВидДокумента, ФорматОбмена, ТекстОшибки)
//		
...
//		Возврат 
//		?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V3, "/opt/in/WayBillAct_v3",
//		?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V2, "/opt/in/WayBillAct_v2", "/opt/in/WayBillAct")
//		);
//		
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.АктПостановкиНаБаланс Тогда
...
//		Возврат "/opt/in/QueryRests";//"/opt/in/QueryRests_v2";
//		
...
//		
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ххх_АктФиксацииМарок Тогда
//		Возврат "/opt/in/ActFixBarCode";
//		
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ххх_АктРазфиксацииМарок Тогда
//		Возврат "/opt/in/ActUnFixBarCode";
//	
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ПередачаВТорговыйЗал Тогда
...
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ТТН Тогда
//		Возврат 
//		?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V3, "/opt/in/WayBill_v3",
//		?(ФорматОбмена = Перечисления.ФорматыОбменаЕГАИС.V2, "/opt/in/WayBill_v2", "/opt/in/WayBill"));
//		
//	ИначеЕсли ВидДокумента = Перечисления.ВидыДокументовЕГАИС.ЧекККМ Тогда
//		Возврат "/xml";
//		

...
Процедура ПередЗаписью(Отказ)
	...
	Если ПерваяНастройкаУзла Тогда
		...
		Если ЗначениеЗаполнено(ДатаНачалаВыгрузкиДокументов) 
			...
			ОбменДаннымиПереопределяемый.ЗаполнитьОстатки(Магазины.ВыгрузитьКолонку("Магазин"), ПолучитьСтруктуруЗаполненияВводаОстатковУзла(ЭтоНовый()), , Отказ);
		КонецЕсли;
	Иначе
		Если Документы.ВводНачальныхОстатковУзла.ВозможноВвестиВводОстатковДляУзла(Ссылка) Тогда
			...
			Если ЗначениеЗаполнено(ДатаНачалаВыгрузкиДокументов) Тогда
				Если ВводОстатков.Пустая() Тогда 
					ОбменДаннымиПереопределяемый.ЗаполнитьОстатки(, ПолучитьСтруктуруЗаполненияВводаОстатковУзла(ЭтоНовый()), ВводОстатков, Отказ);
